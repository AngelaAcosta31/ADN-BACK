...
public class ConsultaControladorReserva {
    ...
    public List<DtoReserva> listarPorFechaEntrada(@RequestParam LocalDateTime fecha_entrada){
    ...
    public List<DtoReserva> listarPorFechaSalida(@RequestParam LocalDateTime fecha_salida){
